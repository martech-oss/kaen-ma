/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../server/wrangler.jsonc --env-interface=AgentBindings` (hash: 852a7a0dbf9ac461ee567e77e8e34779)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_AgentBindings {
  ANTHROPIC_API_KEY: string;
  SERVER_AGENT_API?: Service<typeof import("../server/src/index").AgentBackend>;
}
