/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../server/wrangler.jsonc --env-interface=CloudflareBindings` (hash: 89105df5704dc5413f0c02d0d6385519)
